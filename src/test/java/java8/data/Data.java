...
public class Data {
	...
	public Data() {
		...
		orders = Arrays.asList(new Order(1, johnny, Arrays.asList(peperoni)),
				new Order(2, johnny, Arrays.asList(peperoni)), new Order(3, johnny, Arrays.asList(peperoni)),
				new Order(4, marion, Arrays.asList(reine, fromages)), new Order(5, marion, Arrays.asList(fromages)),
				new Order(6, marion, Arrays.asList(reine)), new Order(7, marion, Arrays.asList(orientale)),
